...
const PLAN_FEATURES: Record<string, string[]> = {
  light: ["月1回までの軽微な修正", "バグ修正対応", "メールサポート（3営業日以内）"],
  standard: ["月3回までの修正", "バグ修正・機能追加（軽微）", "優先メールサポート（1営業日以内）", "月次レポート"],
  premium: ["無制限修正", "機能追加・デザイン変更", "専任担当者による即日対応", "月次改善提案レポート", "アクセス解析レポート"],
};
