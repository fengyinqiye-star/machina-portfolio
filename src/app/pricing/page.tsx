...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "料金プラン | Machina",
    description: "LP制作1万円、Webアプリ3万円、大規模5万円の固定価格。AIエージェントが全自動で開発。制作会社の1/10のコストを実現。",
...
const FAQS = [
  ...
  {
    q: "修正は何回できますか？",
    a: "検収完了後30日以内の重大な不具合（主要機能の不動作・表示不可・重大なセキュリティ脆弱性）は無償対応します。テキスト・画像・色・レイアウトの変更や機能追加は保守プランの範囲内、または別途お見積もりとなります。",
  },
  {
    q: "納品までどのくらいかかりますか？",
  ...
  {
    q: "保守プランを途中で解約できますか？",
    a: "翌月以降いつでも解約できます。納品メールに記載の解約ページ（/cancel/注文ID）からワンクリックで解約でき、残存期間分は日割りで自動返金されます。解約後14日間はサービスを継続し、その後停止します。解約後もGitHubのソースコードはお手元に残ります。",
  },
  {
