...
const PRICING = [
  {
    label: "シンプル — LP・コーポレートサイト",
    price: "1万円",
    days: "2〜3日",
    badge: "フリーランスの1/5〜1/10",
    features: ["静的サイト・LP", "お問い合わせフォーム", "Lighthouse 90以上保証", "検収後30日間の瑕疵担保"],
  },
  {
    label: "ミディアム — 予約・Webアプリ",
    price: "3万円",
    days: "3〜7日",
    badge: "制作会社の1/10",
    features: ["DB設計・API実装", "認証・フォーム連携", "テストカバレッジ80%以上", "検収後30日間の瑕疵担保"],
    highlight: true,
  },
  {
    label: "コンプレックス — 大規模システム",
    price: "5万円",
    days: "1〜2週間",
    badge: "",
    features: ["ECサイト・勤怠管理等", "複雑な権限管理・外部API", "セキュリティ要件対応", "検収後30日間の瑕疵担保"],
  },
];
